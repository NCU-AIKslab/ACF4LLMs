...
def preflight_check(
    ...
    model_size = compression_strategy.get("model_size_gb") or estimate_model_size_gb(model_name)
...
def get_resource_monitor_subagent(spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    model_size = spec.get("model_size_gb") or estimate_model_size_gb(model_name)
