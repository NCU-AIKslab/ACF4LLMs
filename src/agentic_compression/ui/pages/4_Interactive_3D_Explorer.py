...
from ..components import render_pareto_solutions_table
...
if st.session_state.exploration_results:
    ...
    st.image(
        "https://via.placeholder.com/800x400/2c3e50/ecf0f1?text=3D+Pareto+Frontier+Example",
        caption="Interactive 3D visualization will appear here after exploration",
    )
